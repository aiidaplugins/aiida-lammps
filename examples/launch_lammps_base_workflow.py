...
def main(
    ...
    workflow = WorkflowFactory("lammps.base")

    builder = workflow.get_builder()
    builder.lammps.code = code
    builder.lammps.structure = structure
    builder.lammps.parameters = parameters
    builder.lammps.potential = potential
    builder.lammps.metadata.options = options

    _, node = run_get_node(workflow, **builder)
...
if __name__ == "__main__":
    ...
    CODE = orm.load_code("lammps-2021.9-29@localhost")
