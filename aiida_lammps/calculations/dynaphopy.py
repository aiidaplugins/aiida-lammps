...
from aiida_phonopy.common.raw_parsers import (  # pylint: disable=no-name-in-module, import-error
    get_force_constants,
    get_poscar_txt,
)
...
class DynaphopyCalculation(CalcJob):
    ...
    def _init_internal_params(self):
        ...
        self._INPUT_TRAJECTORY = (
            "trajectory"  # pylint: disable=invalid-name, attribute-defined-outside-init
        )
        self._INPUT_CELL = (
            "POSCAR"  # pylint: disable=invalid-name, attribute-defined-outside-init
        )
        ...
        self._OUTPUT_FILE_NAME = (
            "OUTPUT"  # pylint: disable=invalid-name, attribute-defined-outside-init
        )
        ...
        self._default_parser = (
            "dynaphopy"  # pylint: disable=attribute-defined-outside-init
        )
    ...
    def _use_methods(cls):
        ...
        retdict = (
            JobCalculation._use_methods
        )  # pylint: disable=protected-access, undefined-variable
        retdict.update(
            {
                "parameters": {
                    "valid_types": ParameterData,  # pylint: disable=undefined-variable
    ...
    def _prepare_for_submission(self, tempfolder, inputdict):
        ...
        if "temperature" in parameters_data.get_dict():
            ...
            codeinfo.cmdline_params.append(f"{parameters_data.dict.temperature}")
