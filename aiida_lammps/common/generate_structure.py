...
def generate_lammps_structure(
    ...
    :param atom_style: treatment of the particles accroding to lammps, defaults to 'atomic'
    ...
    :param round_dp: precision to which to round the postions, defaults to None
