...
def parameters_md() -> AttributeDict:
    ...
    parameters.compute['ke/atom'] = [{'group': 'all', 'type':[{'keyword': " ", "value": " "}]}]
    parameters.compute['pe/atom'] = [{'group': 'all', 'type':[{'keyword': " ", "value": " "}]}]
    ...
    parameters.fix['box/relax'] = [{'group': 'all', 'type':['iso', 0.0, 'vmax', 0.001]}]
